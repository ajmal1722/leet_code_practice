...
// the expression fn(arr[i], i) evaluates to a truthy value. A truthy value 
// is a value where Boolean(value) returns true.
...
// The returned promise should resolve with a value of 2 + 5 = 7. The time 
